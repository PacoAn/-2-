    ...
    return{
      ...
      questions:[
        ...
        },
        {
          ...
          {props:"<bg> yellow </bg>"},
          {props:'<body bg="black">'},
          {props:'<body background="black">'},
          {props:'<bg color = black>'},
          {props:"<body style='background-color:black'>",correct:true},

        ]

      },
              {question:"In HTML, the element defining a table row is?",
          propositions:[
          {props:"<tablerow>"},
          {props:'<tr>',correct:true},
          {props:'tabr'},
          {props:"trow"},
          {props:"tablerow"},
              ...
              {question:"The HTML tag <pre> displays content in ?",
        propositions:[
          {props:"Preferred form text"},
          {props:'Preformed txt',correct:true},
          {props:'Pre-linked text'},
          {props:"Prepared text format"},
          {props:'Preformed-linked txt format'}

        ]

      },
              {question:"Regural expression in JavaScripts uses the defined string method(s) known to be ?",
        propositions:[
          {props:"search"},
          {props:'toString'},
          {props:'replace'},
          {props:'all of them above'},
          {props:"Both A and C",correct:true},
